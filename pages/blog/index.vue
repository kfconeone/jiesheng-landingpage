...
// const postResponse = await fetch("per_page=10&page=" + currentPage);
    ...
    <div class="bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3 items-start">
                <article class="flex max-w-xl flex-col items-start justify-between" v-for="post in posts.data.value.posts" :key="post.id">
        ...
        <nav class="flex items-center justify-center border-t border-gray-200 px-4 mt-8">
            ...
            <div class="hidden md:-mt-px md:flex">
                <a
                    ...
                    v-for="pageIndex in posts.data.value.totalPage"
                    :key="pageIndex"
                >
                    {{ pageIndex }}</a
                >
            ...
            <div class="-mt-px flex w-0 flex-1 justify-end lg:justify-start">
                <a href="#" class="inline-flex items-center border-t-2 border-transparent pl-1 pt-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700" v-if="currentPage < posts.data.value.totalPage">
                    Next
